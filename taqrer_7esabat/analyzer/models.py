...
class AnalysisResult(models.Model):
    ...
    analysis_mode = models.CharField(max_length=20, choices=MODE_CHOICES, default='auto')
    custom_query = models.TextField(blank=True, default='')
    ...
    def __str__(self):
        mode_str = 'مخصص' if self.analysis_mode == 'custom' else 'تلقائي'
        return f"تحليل ({mode_str}): {self.uploaded_file.original_filename}"
